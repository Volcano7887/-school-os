...
// Satori requires any container with more than one child ELEMENT (not
// just text) to have an explicit display:flex, or it throws — this is
// what was actually crashing the route: several two-<span> label/value
// pairs below had no display set. Every such pair now gets this.
const fieldRow = { display: "flex" as const, fontSize: 20 };
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 30 }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 220 }}>
              <div style={{ width: "100%", borderTop: "1px solid #a1a1aa", display: "flex" }} />
